...
<div style="margin-left:150px;">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span
            class="c-gray en">&gt;</span> 产品列表 <a class="btn btn-success radius r mr-20"
        ...
        <div class="col-md-12 column">
            <ul class="pagination pull-right">
                <#if currentPage lte 1>
                    ...
                    <#else>
                        <li><a href="/sell/seller/order/list?page=${currentPage - 1}&size=${size}">上一页</a></li></#else>
                </#if>
                ...
                <#list 1..productInfoPage.getTotalPages() as index>
                    <#if currentPage == index>
                        ...
                        <#else>
                            <li><a href="/sell/seller/order/list?page=${index}&size=${size}">${index}</a></li></#else>
                    </#if>
                </#list>
                ...
                <#if currentPage gte productInfoPage.getTotalPages()>
                    ...
                    <#else>
                        <li><a href="/sell/seller/order/list?page=${currentPage + 1}&size=${size}">下一页</a></li></#else>
                </#if>
            </ul>
        </div>
...
<script type="text/javascript">
        ...
        callback: {
            beforeClick: function (treeId, treeNode) {
                ...
                if (treeNode.isParent) {
                    ...
                    majorCateName = treeNode.pId;
                    minorCateName = treeNode.name;
                    demoIframe.attr("src","product-list-detail.html");
    ...
    function showList( page , size ) {
        //获取书籍列表
        $.getJSON("bookdetail/list/?majorCateName="+majorCateName+"&minorCateName="+minorCateName+"&page=1&size=20",
            function (_data) {
...
//        <td class="td-manage"><a style="text-decoration:none" onClick="product_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_edit('产品编辑','product-add.html','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'10001')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                    ...
                    for (var i = 0; i < books.length; i++) {
                        ...
                        html += "<td><img src=" + pd.bookCover + "></td>";
