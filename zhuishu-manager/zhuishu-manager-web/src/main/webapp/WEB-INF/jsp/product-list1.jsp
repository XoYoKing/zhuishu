...
<table class="table">
    <tr>
        <td width="80" class="va-t"><ul id="treeDemo" class="ztree"></ul></td>
        <td class="va-t"><IFRAME ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height="600px" SRC="product-list-detail"></IFRAME></td>
    </tr>
</table>
...
<script type="text/javascript">
        ...
        callback: {
            beforeClick: function(treeId, treeNode) {
                ...
                if (treeNode.isParent) {
                    ...
                    demoIframe.attr("src","product-list-detail?majorCateName=" + treeNode.pId +"&minorCateName=" + treeNode.name);
                    return true;
                }
            }
        }
    ...
    $(document).ready(function(){
        ...
        var zTree = $.fn.zTree.getZTreeObj("tree");
        zTree.selectNode(zTree.getNodeByParam("id","东方玄幻"));
    });
